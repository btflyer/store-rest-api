...
def authenticate(username, password):
    ...
    :param password: User's unecrypted password in string format.
    :return: A UserModel object if authentication was succesful, None otherwise.
    """
...
def identity(payload):
    ...
    :parama payload: A dictionary with 'identity' key. which is the user id.
